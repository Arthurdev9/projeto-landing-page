...
export const FeatureSection = () => {
  return (
    <section
      className="container bg-gray-700 grid gap-6
    md:grid-cols-2 pb-8 pt-8 md:py-10"
    >
      <div className="flex flex-col gap-4 p-6 rounded-lg bg-gray-500 md:p-12">
        <span
          className="text-body-tag text-blue-200 bg-blue-400 px-2
      py-1 w-fit rounded-sm uppercase"
        >
          Simples
        </span>
      ...
      py-1 w-fit rounded-sm uppercase"
        ...
        <h2 className="font-sans text-gray-100 text-heading-lg">
          Venda seu público através de uma plataforma única
        </h2>
      </div>
      ...
      <div className="col-span-full flex flex-col gap-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg bg-gray-500 p-6 md:p-12">
          ...
          <div className="flex flex-col items-center justify-center w-full">
            ...
            <Button
              asChild
              className="w-full rounded-full gap-2 mt-4 md:mt-auto md:hidden "
            >
              <Link href="/criar-loja">
                Criar loja grátis
                <ArrowRight />
